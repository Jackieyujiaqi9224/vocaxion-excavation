...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`openpbrFragmentSamplersDeclaration`,o=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`openpbrNormalMapFragmentMainFunctions`,c=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`openpbrNormalMapFragmentFunctions`,u=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`openpbrDielectricReflectance`,f=`struct ReflectanceParams
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`openpbrConductorReflectance`,m=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`openpbrAmbientOcclusionFunctions`,g=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`openpbrGeometryInfo`,v=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`openpbrIblFunctions`,b=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`openpbrNormalMapFragment`,S=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C=`openpbrBlockNormalFinal`,w=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T=`openpbrBaseLayerData`,E=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`openpbrCoatLayerData`,A=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`openpbrThinFilmLayerData`,M=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var N=`openpbrFuzzLayerData`,P=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var F=`openpbrAmbientOcclusionData`,I=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L=`openpbrBackgroundTransmission`,R=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z=`openpbrEnvironmentLighting`,B=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V=`openpbrDirectLightingInit`,H=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);var U=`openpbrDirectLighting`,W=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=W);var G=`openpbrPixelShader`,K=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[G]||(e.ShadersStore[G]=K);var q={name:G,shader:K};export{q as openpbrPixelShader};