...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`shadowsFragmentFunctions`,f=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`imageProcessingFunctions`,m=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`fogFragmentDeclaration`,g=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`logDepthFragment`,v=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`fogFragment`,b=`#ifdef FOG
