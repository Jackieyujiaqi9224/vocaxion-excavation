import{t as e}from"./shaderStore-D-XQlhUT.js";import"./logDepthDeclaration--9UDeOay.js";import"./helperFunctions-BBzu79E7.js";import"./clipPlaneVertex-onZMCwJP.js";import"./logDepthVertex-BoKlEz8T.js";import"./mainUVVaryingDeclaration-B0MsBTDj.js";import"./vertexColorMixing-TQFn3hiz.js";import"./morphTargetsVertex-DDt24wx9.js";import"./openpbrUboDeclaration-Dpeglgtn.js";import"./pbrBRDFFunctions-BM6odzMO.js";var t=`sceneVertexDeclaration`,n=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`openpbrVertexDeclaration`,i=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`openpbrNormalMapVertexDeclaration`,o=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`openpbrNormalMapVertex`,c=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`openpbrVertexShader`,u=`#define OPENPBR_VERTEX_SHADER
...
`;e.ShadersStore[l]||(e.ShadersStore[l]=u);var d={name:l,shader:u};export{d as openpbrVertexShader};