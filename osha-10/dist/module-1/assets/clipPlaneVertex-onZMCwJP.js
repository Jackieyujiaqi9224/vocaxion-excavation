...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`clipPlaneVertexDeclaration`,c=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`instancesVertex`,u=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`bonesVertex`,f=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`bakedVertexAnimation`,m=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`clipPlaneVertex`,g=`#ifdef CLIPPLANE
