import{t as e}from"./shaderStore-D-XQlhUT.js";import"./logDepthDeclaration-ad0KOr5S.js";import"./helperFunctions-DOmb6CgI.js";import"./fogFragment-CtvMj9Gn.js";import"./clipPlaneFragment-DGqZJNeS.js";import"./oitFragment-BzDpUnJM.js";import"./openpbrUboDeclaration-_9HEwJN2.js";import"./pbrDebug-Cqt09UNI.js";import"./pbrBRDFFunctions-BoRc9IRz.js";var t=`openpbrFragmentSamplersDeclaration`,n=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=u);var d=`openpbrAmbientOcclusionFunctions`,f=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x=`openpbrBaseLayerData`,S=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var T=`openpbrCoatLayerData`,E=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var D=`openpbrThinFilmLayerData`,O=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var k=`openpbrFuzzLayerData`,A=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=A);var j=`openpbrAmbientOcclusionData`,M=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=M);var N=`openpbrBackgroundTransmission`,P=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=P);var F=`openpbrEnvironmentLighting`,I=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=I);var L=`openpbrDirectLightingInit`,R=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=R);var z=`openpbrDirectLighting`,B=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=B);var V=`openpbrPixelShader`,H=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[V]||(e.ShadersStoreWGSL[V]=H);var U={name:V,shader:H};export{U as openpbrPixelShaderWGSL};