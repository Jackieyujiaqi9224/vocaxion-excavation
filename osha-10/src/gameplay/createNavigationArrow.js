...
export function createNavigationArrow(scene, player) {
    ...
    const material = new StandardMaterial("navigationArrowMaterial", scene);
    ...
    const head = MeshBuilder.CreateCylinder(
        "navigationArrowHead",
        { diameterTop: 0, diameterBottom: 0.72, height: 0.8, tessellation: 4 },
        scene
    );
    ...
    const markerHead = MeshBuilder.CreateCylinder(
        ...
        { diameterTop: 0.9, diameterBottom: 0, height: 0.8, tessellation: 4 },
        scene
    );
